...
export const seededDebates: DebateThread[] = [
  {
    ...
    spectators: 24,
    aiJudged: false,
    participantIds: ["maya-rivera", "james-kim"],
    ...
    turns: [
      {
        id: "debate-1-turn-1",
        author: "Maya Rivera",
        authorId: "maya-rivera",
        side: "Aff",
        submittedAt: "2026-04-06T15:04:00.000Z",
        summary: "Affirmative constructive submitted.",
        status: "submitted",
        speechUrl:
  ...
  },
  {
    ...
    aiJudged: true,
    winner: "Aff",
    participantIds: ["maya-rivera", "mia-thompson"],
  ...
  },
  {
    ...
    aiJudged: true,
    winner: "Neg",
    participantIds: ["alex-chen", "maya-rivera"],
